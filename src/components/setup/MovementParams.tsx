  ...
  return (
    ...
    >
      <div className="grid-2">
        ...
        <Field label="Layout Scale (pixels per meter)" hint="Defines how many canvas pixels represent one real-world meter">
          <NumberInput value={movement.pixelsPerMeter} min={1} onChange={set('pixelsPerMeter')} />
        </Field>
      </div>
    </Card>
  );
